namespace GeoAlert.App.Services.Loading;
...
internal class LoadingService<TCategory> : ILoadingService<TCategory>
{
	...
	public LoadingService()
	{
		...
		LastLoadingTask = this.WhenAnyValue(s => s.sourceLoadingTasks).Select(s => s.Items.LastOrDefault());
